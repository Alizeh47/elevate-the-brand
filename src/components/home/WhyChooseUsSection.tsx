...
const WhyChooseUsSection = dynamic(() => Promise.resolve(WhyChooseUsSectionComponent), {
  ssr: false
})
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="text-center mb-20">
          <h2 className="text-4xl font-letterform mb-4 relative inline-block">
            why choose us
            <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-16 h-0.5 bg-purple-600"></div>
          </h2>
        ...
        <div className="space-y-32">
          ...
          <div className="flex items-center justify-between relative">
            ...
            {/* Content */}
            <div className="w-[45%]">
              <h3 className="text-3xl text-purple-600 font-light mb-6">
          ...
          <div className="flex items-center justify-between flex-row-reverse relative">
            ...
            {/* Content */}
            <div className="w-[45%]">
              <h3 className="text-3xl text-pink-500 font-light mb-6">
